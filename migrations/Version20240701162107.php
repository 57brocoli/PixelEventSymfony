 ...
 */
final class Version20240701162107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE page_section (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, title VARCHAR(150) NOT NULL, content LONGTEXT DEFAULT NULL, INDEX IDX_D713917A3DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE page_section_image (page_section_id INT NOT NULL, image_id INT NOT NULL, INDEX IDX_C3B01300D3C3D2E4 (page_section_id), INDEX IDX_C3B013003DA5256D (image_id), PRIMARY KEY(page_section_id, image_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
